...
<template>
  <div class="add-user">
    <el-dialog title="修改密级" :visible="show" width="30%" @close="handleClose">
      <el-row>
        <el-col :span="22">
          <el-form :model="form" ref="UpdateManage" label-width="120px" :rules="rules">
            <el-form-item label="密级名称" prop="securityName" >
              <el-input clearable   v-model.trim="form.securityName" placeholder="密级名称"></el-input>
            </el-form-item>
            <el-form-item label="密级级别" prop="leve" >
...
export default {
  ...
  methods: {
    ...
    handleClose() {
      this.$emit("userPageListener", "UpdateManage", false);
      this.$refs.UpdateManage.resetFields();
    },
