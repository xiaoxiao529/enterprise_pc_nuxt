...
<template>
  <div class="add-user">
    <el-dialog title="修改密码规则" :visible="show" width="40%" @close="handleClose">
      <el-row>
        <el-col :span="24">
          <el-form :model="form" ref="UpdateRule" label-width="150px" :rules="rules">
...
export default {
  ...
  methods: {
    ...
    handleClose() {
      this.$emit("userPageListener", "UpdateRule", false);
      this.$refs.UpdateRule.resetFields();
    },
