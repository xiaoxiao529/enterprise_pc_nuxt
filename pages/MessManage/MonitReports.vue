  ...
  export default {
    ...
    data() {
      return {
        ...
        fullInfo: {
          pageName: "检测报告",
          tit: '新增检测计划',
          addUrl: api.forent_url.special_base_url + "/monitReports/uploadFile",
          downloadUrl: api.forent_url.base_url + "/monitReports/download?id=",
          deleteUrl: api.forent_url.special_base_url + "/monitReports/del"
        },
        widgetInfo: {
          tHeaders: [{
            prop: "monitReportName",
            label: "名称",
            align: "left",
    ...
    methods: {
      ...
      getData(safetyAttachName) {
        this.loading = true;
        api.post(api.forent_url.base_url + "/monitReports/query", {
          orgId: this.userObj.orgCode,
          attachmentTypeCode: "NDJCBG",
          pageSize: this.widgetInfo.pageSize,
          pageNo: this.widgetInfo.pageNo,
          planName: safetyAttachName
        }).then(res => {
          if (res.message == "ok") {
