  ...
  export default {
    ...
    data() {
      return {
        ...
        fullInfo: {
          pageName: "评估报告",
          tit: '新增评估报告',
          addUrl: api.forent_url.special_base_url + "/risk/uploadFile",
          downloadUrl: api.forent_url.base_url + "/risk/download?id=",
          deleteUrl: api.forent_url.special_base_url + "/risk/del"
        },
        widgetInfo: {
          tHeaders: [{
              prop: "reportName",
    ...
    methods: {
      ...
      getData(safetyAttachName) {
        this.loading = true;
        api.post(api.forent_url.base_url + "/risk/query", {
          orgId: this.userObj.orgCode,
          attachmentTypeCode: "FXPGBG",
          pageSize: this.widgetInfo.pageSize,
          pageNo: this.widgetInfo.pageNo,
          companyName: safetyAttachName
        }).then(res => {
         if (res.message == "ok") {
