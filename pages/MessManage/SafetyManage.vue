  ...
  export default {
    ...
    data() {
      return {
        ...
        fullInfo: {
          pageName: "安全管理",
          tit: '新增安全计划',
          addUrl: api.forent_url.special_base_url + "/safetyManager/uploadFile",
          downloadUrl: api.forent_url.base_url + "/safetyManager/download?id=",
          deleteUrl: api.forent_url.special_base_url + "/safetyManager/del"
        },
        widgetInfo: {
          tHeaders: [{
            prop: "safetyAttachName",
            label: "名称",
            align: "left",
    ...
    methods: {
      ...
      getData(safetyAttachName) {
        this.loading = true;
        api.post(api.forent_url.base_url + "/safetyManager/query", {
          orgId: this.userObj.orgCode ,
          attachmentTypeCode: "AQGL",
          pageSize: this.widgetInfo.pageSize,
          pageNo: this.widgetInfo.pageNo,
          safetyAttachName: safetyAttachName
        }).then(res => {
          if (res.message == "ok") {
