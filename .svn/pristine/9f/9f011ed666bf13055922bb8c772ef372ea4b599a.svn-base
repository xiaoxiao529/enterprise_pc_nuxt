<template>
  <div class="add-user">
    <el-dialog title="修改系统信息" :visible="show" width="45%" @close="handleClose">
      <el-row>
        <el-col :span="20">
          <el-form :model="form" ref="Updatesystem" label-width="150px" :rules="rules">
            ...
            <el-form-item label="系统编码" prop="xtcode" >
              <el-input clearable   v-model.trim="form.xtcode" placeholder="系统编码" :disabled="form.flag"></el-input>
            </el-form-item>
            ...
            <el-form-item label="所属租户" prop="telephone">
              <el-select  v-model.trim="form.tenantId" placeholder="所属租户" class="setInput">
                <el-option
...
export default {
  ...
  methods: {
    ...
    handleClose() {
      this.$emit("userPageListener", "Updatesystem", false);
      this.$refs.Updatesystem.resetFields();
    },

    handleSubmit() {
      var systemId = this.form.systemId;
      var systemCode = this.form.xtcode;
      // 保存表單
      var userObj = api.getGlobalVal("userObj");
      var params = {
