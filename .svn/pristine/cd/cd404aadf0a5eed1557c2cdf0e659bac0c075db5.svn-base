  ...
  export default {
    ...
    data() {
      return {
        ...
        fullInfo: {
          pageName: "年度计划",
          tit: '新增年度计划',
          addUrl: api.forent_url.special_base_url + "/yearPlan/uploadFile",
          downloadUrl: api.forent_url.base_url + "/yearPlan/download?id=",
          deleteUrl: api.forent_url.special_base_url + "/yearPlan/del"
        },
        widgetInfo: {
          tHeaders: [{
            prop: "planName",
    ...
    methods: {
      ...
      getData(safetyAttachName) {
        this.loading = true;
        api.post(api.forent_url.base_url + "/yearPlan/query", {
          orgId: this.userObj.orgCode,
          attachmentTypeCode: "NDGL",
