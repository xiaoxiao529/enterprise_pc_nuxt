<template>
  <div id="userEdit">
    <el-form ref="form" :rules="rules" :model="form" size="mini" status-icon label-width="80px">
      <nuxt-link to="/authManagement/user/list"><i class="el-icon-back"></i></nuxt-link>
...
<script>
/*<style scoped src="~/assets/css/user.scss"></style>
  */
import api from '~/config/http';
  export default {
         ...
         this.$refs[formName].validate((valid) => {
          if (valid) {
            var params = {
              ...
              tenantId :this.$route.params.rowDetail.tenantId,
              orgCode:this.$route.params.rowDetail.orgCode
            }
            //debugger
    ...
    mounted() {
      //信息回显
        //this.form = this.$route.params.rowDetail;
        ...
        if(JSON.stringify(this.$route.params) == "{}"){
          ...
          let params = {
            tenantId : this.$route.params.rowDetail.tenantId,
            userId : this.$route.params.rowDetail.userId
          }
