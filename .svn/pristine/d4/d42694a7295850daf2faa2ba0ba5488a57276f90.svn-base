<template>
    <div>
        <el-container>
                    ...
                    <el-col :span="19" class="right">
                        <el-row>
                            <el-col :span="12" :offset="3" class="right">
                                <el-row>
                                    <el-col :span="24">
                                        <el-button size="mini" type="primary" icon="el-icon-plus" @click="handleUserClick('add')">新增</el-button>
                                    </el-col>
                        ...
                        <el-table ref="table" :data="tableData" style="width: 100%;" height="100%" >
                            ...
                            <el-table-column min-width="100" label="操作">
                                <template slot-scope="scope">
                                    ...
                                    <el-tooltip v-show="operateAuth.logoff" content="注销" placement="bottom">
                                    ...
                                    <!-- <el-tooltip v-show="operateAuth.locked" :content="iconCont" placement="bottom">
                                        <i @click="handleUserClick('lock',orgObj,scope.row)" :class="scope.row.isLock!='false'?'cloud-unlocked icon-l-new l-icons':'cloud-locked icon-l-new l-icons'"></i>
                                    </el-tooltip> -->
                                    <el-tooltip v-show="operateAuth.locked" :content="iconCont" placement="bottom">
                                        <i @click="handleUserClick('lock',orgObj,scope.row)" :class="classIconLock(scope)"></i>
                                    </el-tooltip>
                                    <el-tooltip v-show="operateAuth.reset" content="重置" placement="bottom">
                                        <i @click="handleUserClick('reset',orgObj,scope.row)" class="ggicon-resets icon-l-new l-icons"></i>
                                    </el-tooltip>

                                    <el-tooltip v-show="operateAuth.role" content="角色配置" placement="bottom">
                                        <i @click="handleUserClick('role',orgObj,scope.row)" class="ggicon-authority icon-l-new l-icons"></i>
                                    </el-tooltip>

                                    <el-tooltip v-show="operateAuth.restore" content="还原" placement="bottom">
                                        <i @click="handleUserClick('restore',orgObj,scope.row)" class="cloud-release icon-l-new l-icons"></i>
                                    </el-tooltip>

                                    <el-tooltip v-show="operateAuth.accept" content="同意申请" placement="bottom">
                                        <i @click="handleUserClick('accept',orgObj,scope.row)" class="ggicon-agree icon-l-new l-icons"></i>
                                    </el-tooltip>

                                    <el-tooltip v-show="operateAuth.refuse" content="拒绝申请" placement="bottom">

                                        <i @click="handleUserClick('refuse',orgObj,scope.row)" class="ggicon-disagree icon-l-new l-icons"></i>
                                    </el-tooltip>
                                </template>
                            </el-table-column>
                        </el-table>
            ...
            <ModifyUser ref="formModifyUser" :form="userObj" :loginName="userObj.loginNameValidate" :show="formObj.editFormVisible" @userPageListener="userPageListener"></ModifyUser>
            <ModifyRoleUser ref="formModifyRoleUser" :form="userObj" :show="formObj.roleFormVisible" @userPageListener="userPageListener"></ModifyRoleUser>
            <AddUser :show="formObj.addFormVisible" @userPageListener="userPageListener"></AddUser>
            <RefuseUser :show="formObj.refuseFormVisible" @userPageListener="userPageListener" :userObj="userObj"></RefuseUser>
        </el-container>
...
export default {
    ...
    methods: {
        ...
        getUserList(userStatus) {
            ...
            return api.post(url + "/user/list.mvc", params).then(res => {
                if (!res.data) {}
